...
export async function seed() {
  ...
  // Models from OFFICIAL sources (June 2026)
  // Source: developers.openai.com, platform.claude.com, ai.google.dev
  const models = [
    // ═══ OpenAI (source: developers.openai.com/api/docs/models/all) ═══
    // Frontier
    ...
    { id: "openai/gpt-5.4-nano", providerId: "openai", displayName: "GPT-5.4 Nano", contextLength: 400000, priceIn: 1e-7, priceOut: 4e-7, streaming: true, vision: true, tools: true },
    // Specialized
    ...
    // Previous frontier (still current)
    { id: "openai/gpt-5.2", providerId: "openai", displayName: "GPT-5.2", contextLength: 1000000, priceIn: 2.5e-6, priceOut: 1.5e-5, streaming: true, vision: true, tools: true },
    { id: "openai/gpt-5.1", providerId: "openai", displayName: "GPT-5.1", contextLength: 1000000, priceIn: 2e-6, priceOut: 8e-6, streaming: true, vision: true, tools: true },
    { id: "openai/gpt-5", providerId: "openai", displayName: "GPT-5", contextLength: 1000000, priceIn: 2e-6, priceOut: 8e-6, streaming: true, vision: true, tools: true },
    { id: "openai/gpt-5-mini", providerId: "openai", displayName: "GPT-5 Mini", contextLength: 1000000, priceIn: 4e-7, priceOut: 1.6e-6, streaming: true, vision: true, tools: true },
    { id: "openai/gpt-5-nano", providerId: "openai", displayName: "GPT-5 Nano", contextLength: 1000000, priceIn: 1e-7, priceOut: 4e-7, streaming: true, vision: true, tools: true },
    // Reasoning
    { id: "openai/o3-pro", providerId: "openai", displayName: "o3-pro", contextLength: 200000, priceIn: 2e-5, priceOut: 8e-5, streaming: true, vision: true, tools: true },
    ...
    // Open-weight
    { id: "openai/gpt-oss-120b", providerId: "openai", displayName: "GPT-OSS 120B", contextLength: 128000, priceIn: 0, priceOut: 0, streaming: true, vision: false, tools: false },
    ...
    // ═══ Google (source: ai.google.dev/gemini-api/docs/models) ═══
    // Gemini 3 series
    ...
    // ═══ Fireworks (inference) ═══
    { id: "fireworks/llama-v3p3-70b-instruct", providerId: "fireworks", displayName: "Llama 3.3 70B (Fireworks)", contextLength: 131072, priceIn: 9e-7, priceOut: 9e-7, streaming: true, vision: false, tools: false },
