...
export class MistralProvider implements Provider {
  ...
  listModels(): ModelInfo[] {
    ...
    return [
      { id: "mistral-large-latest", object: "model", created: now, owned_by: "mistral" },
      { id: "mistral-small-latest", object: "model", created: now, owned_by: "mistral" },
      { id: "codestral-latest", object: "model", created: now, owned_by: "mistral" },
    ];
  }
